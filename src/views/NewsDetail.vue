...
import type { Vote } from '../stores/newsInterface';
      ...
      <!-- <div class="text-center py-20">
        <div class="inline-flex flex-col items-center w-full max-w-md">
          <div class="w-full bg-gray-200 rounded-full h-2 mb-4 overflow-hidden">
            <div
              class="h-full bg-gradient-to-r from-yellow-200 via-nike-yellow to-nike-orange transition-all duration-300 rounded-full relative"
